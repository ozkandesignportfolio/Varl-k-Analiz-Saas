...
const REPORT_PATH = path.join(ROOT, 'testsprite_tests', 'tmp', 'trial_test_report.json');
const SERVER_LOG_PATH = path.join(ROOT, 'testsprite_tests', 'tmp', 'trial_devserver_live.log');
...
async function run() {
  ...
  try {
    ...
    const submitButton = page
      .locator('form button[type="submit"], form button:has-text("Giri�"), form button:has-text("Giris"), form button:has-text("Login"), form button:has-text("Sign in"), form button:has-text("Giri� Yap")')
      .first();
