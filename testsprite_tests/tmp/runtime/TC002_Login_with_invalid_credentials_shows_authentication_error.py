...
async def run_test():
    ...
    try:
        ...
        # -> Type os.getenv('TEST_LOGIN_EMAIL', '') into the email field (index 1995), then type os.getenv('TEST_LOGIN_PASSWORD', '') into the password field (index 1996), then click the 'Giriş Yap' button (index 1997).
        frame = context.pages[-1]
        # Input text
