...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Giriş Yap' (Sign in) link to open the login page so credentials can be entered.
        ...
        # -> Type the email into the email field (index 2007) and then enter the password and submit the form.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Service Entry Saved').first).to_be_visible(timeout=3000)
