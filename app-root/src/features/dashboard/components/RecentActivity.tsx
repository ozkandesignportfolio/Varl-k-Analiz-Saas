      ...
      {items.length === 0 ? (
        ...
        <ul className="mt-4 space-y-2.5">
          {items.map((item) => {
            ...
            return (
              <li key={item.id} className="list-none rounded-xl border border-[#314866] bg-[#0E1E37]/75 p-3 transition-colors duration-150 hover:border-[#3D5A7E] hover:bg-[#0E1E37]">
