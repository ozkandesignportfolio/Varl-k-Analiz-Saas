      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <div className="glass-card rounded-3xl p-8 sm:p-12 md:p-16 animate-pulse-glow">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 mb-8">
            ...
            <span className="text-xs tracking-widest text-primary">BAŞLANGIÇ</span>
          </div>

          <h2 className="text-3xl font-bold text-foreground sm:text-4xl lg:text-5xl text-balance">
            Yazılım varlıklarınızı
            <br />
            <span className="text-gradient">düzene koyun</span>
          </h2>

          <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
            Ücretsiz plan ile başlayın. Kredi kartı gerekmez.
            İhtiyacınız büyüdükçe yükseltebilirsiniz.
          </p>
          ...
          <p className="mt-8 text-sm text-muted-foreground">
            Ücretsiz planda {trialAssetLimit} varlık, {trialDocumentLimit} belge, {trialSubscriptionLimit} abonelik ve{" "}
            {trialInvoiceUploadLimit} fatura kaydı
          </p>
        </div>
      </div>
    </section>
