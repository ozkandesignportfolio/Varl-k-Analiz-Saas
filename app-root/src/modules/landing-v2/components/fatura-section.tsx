...
export function FaturaSection() {
  ...
  return (
    <section id="fatura" className="relative isolate py-32" ref={ref}>
      ...
      <div className="pointer-events-none absolute bottom-1/3 right-0 z-0 h-80 w-80 rounded-full bg-accent/5 blur-[120px]" />
