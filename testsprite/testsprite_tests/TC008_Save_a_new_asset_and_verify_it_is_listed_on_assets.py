...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with $TEST_LOGIN_EMAIL and then fill password and click Sign in.
        ...
        await expect(frame.locator('text=Test Asset - List Verify').first).to_be_visible(timeout=3000)
