...
export default function BillingSuccessPage() {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-3xl flex-col items-center justify-center px-6 text-center">
      <h1 className="text-3xl font-semibold text-white">Odeme basarili</h1>
      <p className="mt-3 text-sm text-slate-300">
        Abonelik isleminiz alindi. Planiniz webhook tamamlandiginda premium olarak guncellenecek.
      </p>
      <Link
        href="/settings"
